#This is the receive client of clientB
...
if __name__ == '__main__':
    ...
    with open('unconfirmed_TB.txt', 'r') as f:
        for line in f:
    ...
    while 1:
        ...
        if payer == "B0000001" or payer == "B0000002" :
            ...
            with open('Unconfirmed_TB.txt', 'w') as f:
                for item in unconfirmed_Txs:
                    f.write("%s\n" % item)
        #if the client is a payee
        if payee == "B0000001" or payee == "B0000002":
            f = open("Confirmed_TB.txt", 'a')
            f.write(received_transaction + "\n")
            f.close()
